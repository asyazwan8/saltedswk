      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-10">
        ...
        <section>
          <h2 className="text-[22px] font-bold mb-4 flex items-center gap-2">
            <MapPin className="text-[#CC0000]" size={22} /> Location
          </h2>
          ...
          <div className="rounded-xl overflow-hidden border border-[#E5E5E5] h-[280px] bg-[#F9F9F9] flex items-center justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#CC0000] hover:bg-[#990000] text-white font-bold text-[16px] px-6 min-h-[52px] rounded-xl"
            >
        ...
        <section>
          <h2 className="text-[22px] font-bold mb-4 flex items-center gap-2">
            <Clock className="text-[#CC0000]" size={22} /> Opening Hours
          </h2>
            ...
            <tbody>
              {[
                ...
                <tr key={day} className="border-b border-[#E5E5E5]">
                  ...
                  <td className={`py-2 ${hours === 'CLOSED' ? 'text-[#CC0000] font-semibold' : 'text-[#555555]'}`}>
                    {hours}
                  </td>
                </tr>
              ))}
          ...
          <ul className="space-y-3 text-[16px]">
            <li>
              <a
                ...
                className="flex items-center gap-3 text-[#555555] hover:text-[#CC0000] min-h-[52px]"
              >
          ...
          <ul className="space-y-3 text-[16px]">
            <li>
              <a
                ...
                className="flex items-center gap-3 text-[#555555] hover:text-[#CC0000] min-h-[52px]"
              >
                <span className="text-[#CC0000]"><InstagramIcon size={20} /></span>
            ...
            <li>
              <a
                ...
                className="flex items-center gap-3 text-[#555555] hover:text-[#CC0000] min-h-[52px]"
              >
                <span className="text-[#CC0000]"><FacebookIcon size={20} /></span>
                SALTed on Facebook
              </a>
            </li>
          </ul>
