    ...
    <div className="max-w-lg space-y-6">
      ...
      <div className="flex gap-3">
        <input
          ...
          className="flex-1 border border-[#E5E5E5] rounded-xl px-4 py-3 text-[16px] focus:outline-none focus:border-[#CC0000] min-h-[52px]"
        />
        <button
          onClick={addCategory}
          className="bg-[#CC0000] hover:bg-[#990000] text-white font-bold px-5 min-h-[52px] rounded-xl"
        >
          Add
        </button>
      </div>
            ...
            {editingId === cat.id ? (
              <>
                <input
                  ...
                  className="flex-1 border border-[#E5E5E5] rounded-lg px-3 py-2 text-[16px] focus:outline-none focus:border-[#CC0000] min-h-[44px]"
                  autoFocus
                />
                <button
