  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {stats.map((s) => (
          <Link
            key={s.label}
            href={s.href}
            className="bg-white border border-[#E5E5E5] rounded-2xl p-5 hover:border-[#1A1A1A] hover:shadow-sm transition-all"
          >
      ...
      <div className="flex gap-4 flex-wrap">
        <Link
          href="/admin/menu/new"
          className="bg-[#1A1A1A] hover:bg-[#000000] text-white font-bold text-[16px] px-6 min-h-[52px] rounded-xl inline-flex items-center"
        >
          + Add Menu Item
        </Link>
        <Link
