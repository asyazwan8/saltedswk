          ...
          {items.length === 0 ? (
            ...
            <>
              {items.map((item) => (
                <div key={item.id} className="border border-[#E5E5E5] rounded-xl p-4 space-y-3">
                  <div className="flex justify-between items-start gap-3">
                    ...
                    <p className="text-[16px] font-bold text-[#1A1A1A] whitespace-nowrap">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-[#E5E5E5] rounded-lg px-3 py-2 text-[16px] focus:outline-none focus:border-[#1A1A1A]"
                    />
                  </div>
                </div>
              ))}
              ...
              <div className="flex justify-between items-center py-3 border-t border-[#E5E5E5]">
                ...
                <span className="text-[18px] font-bold text-[#1A1A1A]">RM {total.toFixed(2)}</span>
              </div>
              ...
              <button
                onClick={handleSend}
                className="w-full bg-[#1A1A1A] hover:bg-[#000000] text-white font-bold text-[18px] min-h-[56px] rounded-xl transition-colors"
              >
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={confirmSend}
                className="flex-1 bg-[#1A1A1A] hover:bg-[#000000] text-white rounded-xl min-h-[52px] text-[16px] font-bold"
              >
                Open WhatsApp
              </button>
            </div>
