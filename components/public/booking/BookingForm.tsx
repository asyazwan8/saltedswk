      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-lg mx-auto" noValidate>
        ...
        <div>
          <label className="block font-semibold text-[16px] mb-2">
            Date <span className="text-[#1A1A1A]">*</span>
          </label>
        ...
        <div>
          <label htmlFor="booking-time" className="block font-semibold text-[16px] mb-2">
            Time <span className="text-[#1A1A1A]">*</span>
          </label>
          <select
            id="booking-time"
            value={time}
        ...
        <div>
          <span className="block font-semibold text-[16px] mb-2">
            Number of Guests <span className="text-[#1A1A1A]">*</span>
          </span>
        ...
        <div>
          <label htmlFor="booking-phone" className="block font-semibold text-[16px] mb-2">
            Phone Number <span className="text-[#1A1A1A]">*</span>
          </label>
          <input
            id="booking-phone"
            type="tel"
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                onClick={() => setShowConfirm(false)}
                className="flex-1 bg-[#1A1A1A] hover:bg-[#000000] text-white rounded-xl min-h-[52px] text-[16px] font-bold flex items-center justify-center"
              >
                Open WhatsApp
              </a>
            </div>
