  ...
  return (
    <footer className="bg-[#111111] text-white mt-auto">
      <div className="max-w-5xl mx-auto px-4 py-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Brand */}
        <div>
          <div className="text-2xl font-bold text-[#CC0000] mb-2">SALTed</div>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="inline-flex items-center justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-[#CC0000] transition-colors"
